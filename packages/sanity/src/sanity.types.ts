...
// Query: *[_type == "product" && store.productType == $productType && store.slug.current != $handle && store.status == "active"][0...4]{    _id,    "slug": store.slug.current,    store{      title,      priceRange,      previewImageUrl,      vendor,      "variantPreviewImageUrl": variants[0]->store.previewImageUrl    }  }
export type QueryRelatedProductsResult = Array<{
  ...
  store: {
    ...
    previewImageUrl: string | null;
    vendor: string | null;
    variantPreviewImageUrl: string | null;
  } | null;
}>;
